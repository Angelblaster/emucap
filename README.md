...
**v0.10.0-rc.1 — release candidate.** Interfaces and behavior may still change before
the stable 0.10.0 release. Adapter availability remains host-dependent and is reported
by `status`.
